      ...
      <div className='flex items-center justify-between'>
          <div className='mx-7'>
            <h4 className='text-4xl uppercase font-bold'>
              R<span className='text-cyan-600'>idu</span>an
            </h4>
          </div>
          ...
          className={`z-[1002] ${open ? "text-gray-900" : "text-gray-200"} text-3xl md:hidden m-5 cursor-pointer`}>
            <ion-icon name="menu"></ion-icon>
          </div>
          <div className={`md:hidden text-gray-900 absolute w-2/3 h-screen px-7 py-2 font-medium bg-white top-0
