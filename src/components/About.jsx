              ...
              <div className='flex items-center justify-center md:flex-row flex-col-reverse   md:gap-4 gap-8  px-10 max-w-6xl mx-auto'>
                <div className='flex-1'>
                  ...
                  <p className='text-gray-200 my-3 text-lg font-bold'>My Introduction</p>
                   ...
                   <a href="src\assets\Resume of Md. Riduanul Haque .pdf" download> <button className=' flex self-start bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mt-8 '>Download Resume</button></a>
                  </div> 
                </div>
